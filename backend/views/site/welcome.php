...
<div class="page-container">
    <p class="f-20 text-success">欢迎使用Shop-PHP-Yii2 <span class="f-14">v1.0.0</span>后台管理系统！</p>
    <p>登录次数：18 </p>
...
<footer class="footer mt-20">
    <div class="container">
        <p>感谢 Linux、Nginx、Apache、Workerman、Redis、ElasticSearch、MySQL、PHP、Composer、Yii2、jQuery、H-UI<br>
            Copyright &copy;2016 EleTeam. All Rights Reserved.<br>
            本后台系统由<a href="http://eleteambackend.ygcr8.com" target="_blank" title="Shop-PHP-Yii2">EleTeam.</a>提供技术支持</p>
    </div>
</footer>
